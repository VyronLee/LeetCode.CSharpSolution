// ------------------------------------------------------------
//         File: Solution0232.cs
//        Brief: Solution0232.cs
//
//       Author: VyronLee, lwz_jz@hotmail.com
//
//      Created: 2024-3-4 17:50
    ...
    public class Solution0232
    {
        public class MyQueue {
            ...
            public void Push(int x) {
                CopyTo(_stack1, _stack2);
                _stack1.Push(x);
                CopyTo(_stack2, _stack1);
            }
            ...
            private void CopyTo(Stack<int> from, Stack<int> to) {
                while (from.Count > 0) {
                    to.Push(from.Pop());
                }
            }
