// ------------------------------------------------------------
//         File: Solution0225.cs
//        Brief: Solution0225.cs
//
//       Author: VyronLee, lwz_jz@hotmail.com
//
//      Created: 2024-3-3 21:50
...
namespace LeetCode
{
    public class Solution0225
    {
        private class MyStack
        {
            ...
            private void CopyTo(Queue<int> from, Queue<int> to) {
                while (from.Count > 0) {
