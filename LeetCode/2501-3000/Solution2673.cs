// ------------------------------------------------------------
//         File: Solution2673.cs
//        Brief: Solution2673.cs
//
//       Author: VyronLee, lwz_jz@hotmail.com
//
//      Created: 2024-2-28 18:50
...
//
//
// Related Topics 贪心 树 数组 动态规划 二叉树 👍 57 👎 0
    ...
    public class Solution2673
    {
        public int MinIncrements(int n, int[] cost) {
            ...
            for (var i = n - 2; i >= 1; i-=2) {
                cost[(i+1)/2-1] += Math.Max(cost[i+1], cost[i]);
                operations += Math.Abs(cost[i+1] - cost[i]);
            }
            return operations;
        }
    }
